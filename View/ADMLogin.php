...
<body class="w3-light-grey">
    ...
    <form action="Controller/Navegacao.php" method="post" class="w3-container w3-card-4 w3-light-grey w3-text-blue w3-margin w3-display-middle" style="width: 30%;">
        ...
        <div class="w3-row w3-section">
            ...
            <div class="w3-rest">
                <input class="w3-input w3-border w3-round-large" name="txtLoginADM" type="text" placeholder="Login CPF (ex.: 33333333333)" required>
            </div>
        </div>
        ...
        <div class="w3-row w3-section">
            <button name="btnLoginADM" class="w3-button w3-block w3-blue w3-round-large" style="width: 100%;">Entrar</button>
        </div>
    </form>
